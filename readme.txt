*****************************************************************************************
                    Jam STAPL Player Version 2.6.2 README 07Mar2025
*****************************************************************************************
...
the JTAG port. Jam STAPL Player v2.6 supports the Standard Test and Programming 
...
and data are confined to the Jam STAPL File. The Jam STAPL Player version 2.6 supports 
...
C. NEW IN VERSION 2.6
----------------------
The updates in the Jam STAPL Player version 2.6 include:

*   fixed statement buffer overflow
*   fixed signed and unsigned comparison between index and JAMC_MAX_STATEMENT_LENGTH
*   replaced strcpy with strcpy_s
*   updated comments
...
This readme file does not discuss customization of serial mode. 
...
this case, first take the steps outlined in Section E for debugging the Player. 
...
release of the Jam STAPL Player, e-mail support@intel.com. 
